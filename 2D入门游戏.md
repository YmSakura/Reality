...
![image-20211101173407478](https://image-ym.oss-cn-guangzhou.aliyuncs.com/img/image-20211101173407478.png)
...
设置好这些之后，将敌人变成预制体，就可以通过调整每一个敌人各自子物体的位置来调整移动范围。

## Session16：Animation Events动画事件

### 解决问题

首先有一个问题，就是人物从高处下落的时候不是falling动画，我们需要在SwitchAnimation()里添加以下语句
...
<img src="https://image-ym.oss-cn-guangzhou.aliyuncs.com/img/image-20211101185901789.png" alt="image-20211101185901789" style="zoom:67%;" />
...
因为青蛙要跳动，所以要添加一个y轴方向的速度，而且只有在地面上时才可以跳动。



但是这样青蛙就会一直处于jump的状态，没法回到idle，所以我们需要新的方法：Aniamtion Event，在Animation界面可以找到

<img src="https://image-ym.oss-cn-guangzhou.aliyuncs.com/img/image-20211101190555198.png" alt="image-20211101190555198" style="zoom:67%;" />



添加之后可以挪动event的位置，并可在右侧设置想要执行的函数，我们想要执行Movement()，把它添加进去

<img src="https://image-ym.oss-cn-guangzhou.aliyuncs.com/img/image-20211101190659650.png" alt="image-20211101190659650" style="zoom:67%;" />
